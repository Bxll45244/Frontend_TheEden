...
import { useNavigate } from "react-router-dom"; // ✅ เพิ่มใช้ useNavigate
...
const Dashboard = () => {
  const navigate = useNavigate(); // ✅ hook สำหรับปุ่มย้อนกลับ
  ...
  return (
    <div className="min-h-screen bg-white font-inter px-4 py-6">
      {/* ✅ ปุ่มย้อนกลับ (สไตล์เดียวกับหน้าอื่น) */}
      ...
      <section className="max-w-6xl mx-auto">
        ...
        <div className="border-2 border-gray-600 rounded-xl p-4 shadow-lg">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 justify-items-center sm:justify-items-stretch">
            ...
            <HoleCard title="แจ้งสถานะกำลังแก้ไข" color="blue" showName={true} showIssue={false} ask={askHoleAction} />
            ...
            <HoleCard title="สลับรถกอล์ฟให้กลุ่มนี้" color="yellow" showName={true} showIssue={false} ask={askHoleAction} />
          </div>
        </div>
      </section>
